...
void printFile(){
    ...
    while(temp!=NULL){
        ...
        fprintf(filePointer, "Name: %s\nDate: %s\nAddress: %s\nExpense: %d\nOrganiser: %s\nCheif Guest: %s\nTheme: %s\n", temp->name, temp->date, temp->address, temp->expense, temp->organiser, temp->chiefg, temp->theme);
        fprintf(filePointer, "-----X-----\n");
        temp = temp->link;
        // fprintf(filePointer, "Event address: ");
        // fprintf(filePointer, temp->address);
        // // fprintf("\n", filePointer);
        // fprintf(filePointer, "\n");
        // fprintf(filePointer, "Event date: ");
        // fprintf(filePointer, temp->date);
        // fprintf(filePointer, "\n");
        // // fprintf("\n", filePointer);
        // fprintf(filePointer, "\n");
        // fprintf(filePointer, "Event Chief Guest: ");
        // fprintf(filePointer, temp->chiefg);
        // // fprintf("\n", filePointer);
        // fprintf(filePointer, "\n");
        // fprintf(filePointer, "Event organiser: ");
        // fprintf(filePointer, temp->organiser);
        // // fprintf("\n", filePointer);
        // fprintf(filePointer, "\n");
        // fprintf(filePointer, "Event theme: ");
        // fprintf(filePointer, temp->theme);
        // // fprintf("\n", filePointer);
        // fprintf(filePointer, "\n");
        // fprintf(filePointer, "Event expense: ");
        // fprintf(filePointer, "%d", temp->expense);
        // // fprintf("\n", filePointer);
        // fprintf(filePointer, "\n");
        // fprintf(filePointer, "-----X-----");
        // // fprintf("\n", filePointer);
...
int main()
{
    ...
    char uno[20]="pdeu",pass[20]="pdeu12345";
