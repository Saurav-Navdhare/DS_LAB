...
#include <stdbool.h>
#define MAX 30
// Structure for a phone directory
struct Contact_book {
...
}// Function to delete a contact it act like delete node in list by name
...
// If the contact is not in the list
   if(flag==1 && temp!=head && temp->next!=NULL)
    {
      temp->previous->next=temp->next;
      temp->next->previous=temp->previous;
...
// Function to delete a contact by mail
...
int main()
{
  //calling the menu function
    ...
    printf("\n\n");
    // here we select the choice which operation to be performed
    do {
        printf("\nEnter a choice\n0. Exit\n1. Add\n2. Display\n3. Search a contact\n4. Delete contact\n5. Update Contact\n6. Clear screen\n");
        scanf("%d", &option);
        switch(option){
